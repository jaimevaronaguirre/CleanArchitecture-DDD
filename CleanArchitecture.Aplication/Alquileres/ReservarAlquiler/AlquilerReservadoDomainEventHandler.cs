...
{
    internal sealed class AlquilerReservadoDomainEventHandler :
        INotificationHandler<AlquilerReservadoDomainEvent>
    {
        ...
        public AlquilerReservadoDomainEventHandler(
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _emailService.SendAsync(
                user.Email!,
                "Alquiler Reservado", "Tienes que confirmar esta reserva de lo contrario se va a perder");
        }
    }
}
