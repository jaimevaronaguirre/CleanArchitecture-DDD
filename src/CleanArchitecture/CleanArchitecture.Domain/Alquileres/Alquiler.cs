...
namespace CleanArchitecture.Domain.Alquileres
{
    public sealed class Alquiler : Entity
    {
        ...
        )
        {
            ...
            vehiculo.FechaUltimaAlquiler = fechareacion;
        ...
        public Result Confirmar(DateTime utcNow)
        {
            ...
            RaiseDomainEvent(new AlquilerConfirmadoDomaiinEvent(Id));
        ...
        public Result Rechazar(DateTime utcNow)
        {
            ...
            RaiseDomainEvent(new AlquilerRechazadoDomaiinEvent(Id));
        ...
        public Result Cancelar(DateTime utcNow)
        {
           ...
           var currentDate = DateOnly.FromDateTime(utcNow);
            ...
            Status = AlquilerStatus.Canceldo;
            FechaCancelacion = utcNow;
            RaiseDomainEvent(new AlquilerCanceladoDomaiinEvent(Id));
        ...
        public Result Completar(DateTime utcNow)
        {
            ...
            RaiseDomainEvent(new AlquilerCompletadoDomaiinEvent(Id));
