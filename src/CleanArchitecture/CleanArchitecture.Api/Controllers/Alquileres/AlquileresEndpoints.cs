...
public static class AlquileresEndpoints
{
    ...
    public static IEndpointRouteBuilder MapAlquilerEndpoints(this IEndpointRouteBuilder builder)
    {
        ...
        builder.MapGet("alquileres/{id}", GetAlquiler).RequireAuthorization(PermissionEnum.ReadUser.ToString())
            .WithName(nameof(GetAlquiler));

        builder.MapPost("alquileres", ReservaAlquiler).RequireAuthorization(PermissionEnum.WriteUser.ToString()); ;
